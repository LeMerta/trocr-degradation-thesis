...
Each degraded set is saved under:
    iam/combined_degradations/train/mixed_train.parquet
    iam/combined_degradations/train/mixed_val.parquet
"""
...
# Degrade train set
target_path = f"iam/combined_degradations/train/mixed_train.parquet"
...
# Degrade val set
target_path = f"iam/combined_degradations/train/mixed_val.parquet"
